/* unchanged from FrameworkBenchmarks except user changed from benchmarkdbuser to postgres */
...
GRANT SELECT, UPDATE ON World to postgres;
...
GRANT SELECT ON Fortune to postgres;
